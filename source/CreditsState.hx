...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Pure Engine'],
			['MrClogsworthYT',		'MrClogsworthYT',		'Main Programmer of Pure Engine',						'https://youtube.com/c/MrClogsworthYT',	'FFFFFF'],
			[''],
			['Psych Engine Team'],
	...
	override function update(elapsed:Float)
	{
		...
		warningText.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.RED, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
