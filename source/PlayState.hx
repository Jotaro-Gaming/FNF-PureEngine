...
class PlayState extends MusicBeatState
{
	...
	var pureEngineWatermark:FlxText;
	...
	override public function create()
	{
		...
		add(scoreTxt);
	        ...
	        // mamamia ma watermark
		/*pureEngineWatermark = new FlxText(4, healthBarBG.y + 50, FlxG.width, "Pure Engine" + MainMenuState.pureEngineVersion, 0);
		pureEngineWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		pureEngineWatermark.scrollFactor.set();
		pureEngineWatermark.borderSize = 1.25;
		pureEngineWatermark.visible = !ClientPrefs.hideHud;
		add(pureEngineWatermark);*/
	
	        var pureEngineWatermark = new FlxText(12, FlxG.height - 44, 0, "Pure Engine v" + MainMenuState.pureEngineVersion, 12);
		pureEngineWatermark.scrollFactor.set();
		pureEngineWatermark.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	        pureEngineWatermark.visible = !ClientPrefs.hideHud;
		add(pureEngineWatermark);
